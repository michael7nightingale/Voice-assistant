...
import os
ICONS_DIR = os.getcwd().replace(r"\UI", "", -1).replace(r'\src', '', -1) + "\\icons\\"
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon(f"{ICONS_DIR}logo/microphone.png"))
        ...
        self.titlemenu.setMaximumSize(QtCore.QSize(16777215, 70))
        ...
        self.logo = QtWidgets.QWidget(self.titlemenu)
        self.logo.setGeometry(QtCore.QRect(0, 0, 71, 71))
        # self.logo.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/microphone.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        # self.logo.setIcon(icon)
        # self.logo.setIconSize(QtCore.QSize(50, 50))
        self.logo.setStyleSheet(f"background-image: url(:logo/microphone.png);")
...
"font: 57 12pt \"Source Code Pro Medium\";")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/circle-user.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.my_account.setIcon(icon1)
        self.my_account.setIconSize(QtCore.QSize(50, 50))
        self.my_account.setObjectName("my account")
...
"font: 57 12pt \"Source Code Pro Medium\";")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/chart-user.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.change_account.setIcon(icon2)
        self.change_account.setIconSize(QtCore.QSize(50, 50))
        self.change_account.setObjectName("change account")
        self.verticalLayout_5.addWidget(self.change_account)
        #
        self.label_createaccount = QtWidgets.QLabel(self.page)
        self.label_createaccount.setMaximumSize(QtCore.QSize(16777215, 50))
        self.label_createaccount.setStyleSheet("background-color: rgb(255, 255, 255);\n"
                                               "font: 57 12pt \"Source Code Pro Medium\";")
        self.label_createaccount.setObjectName("label_changeaccount")
        self.verticalLayout_5.addWidget(self.label_createaccount)

        self.button_createaccount = QtWidgets.QPushButton(self.page)
        self.button_createaccount.setMaximumSize(QtCore.QSize(60, 60))
        self.button_createaccount.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/3917698.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.button_createaccount.setIcon(icon7)
        self.button_createaccount.setIconSize(QtCore.QSize(50, 50))
        self.button_createaccount.setObjectName("create account")
        self.verticalLayout_5.addWidget(self.button_createaccount)
        #
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/portrait.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"font: 57 12pt \"Source Code Pro Medium\";")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/volume.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"font: 57 12pt \"Source Code Pro Black\";")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/3917762.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.button_open_sidebar.setObjectName("open_sidebar")
...
"font: 57 18pt \"Source Code Pro Black\";")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/trash.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"font: 57 12pt \"Source Code Pro Medium\";")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/chart-line-up.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.button_news.setIcon(icon8)
        self.button_news.setIconSize(QtCore.QSize(50, 50))
        self.button_news.setObjectName("news")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/interrogation.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.button_ask.setIcon(icon9)
        self.button_ask.setIconSize(QtCore.QSize(50, 50))
        self.button_ask.setObjectName("commands")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/world.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.button_search.setIcon(icon10)
        self.button_search.setIconSize(QtCore.QSize(50, 50))
        self.button_search.setObjectName("websearch")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/3914110.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.button_mathmode.setIcon(icon11)
        self.button_mathmode.setIconSize(QtCore.QSize(50, 50))
        self.button_mathmode.setObjectName("mathmode")
...
"")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(f"{ICONS_DIR}logo/megaphone.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_createaccount.setText(_translate("MainWindow", "Регистрация"))
